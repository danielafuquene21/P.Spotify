...
class RemotePlayerKotActivity : AppCompatActivity() {
    ...
    private var playerStateSubscription: MediaBrowser.SubscriptionCallback<PlayerState>? = null
    private var playerContextSubscription: MediaBrowser.SubscriptionCallback<PlayerContext>? = null
    private var capabilitiesSubscription: MediaBrowser.SubscriptionCallback<Capabilities>? = null
